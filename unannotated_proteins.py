...
def annotate_proteins():
    ...
    prots_file_path = '/Users/hudaiber/data/Pty/unannotated_proteins/unannotataed_prots.fa'
    ...
    for seq in prots:
        ...
        print 'Searching for protein:', seq.description
        found = False

        for f in os.listdir(os.path.join(prots_genomes_path,curGenome)):
            if found:
                continue
...
if __name__=='__main__':
    ...
    fasta_file = os.path.join(folder_path, 'unannotataed_prots.fa')
